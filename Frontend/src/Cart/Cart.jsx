...
const Cart = () => {
  ...
  return (
    <div className="my-8 px-4 sm:px-6 lg:px-20">
      ...
      {/* Mobile Label */}
      <div className="sm:hidden font-semibold text-gray-700 text-lg mb-2">
        Cart Items
      </div>
        ...
        if (quantity > 0) {
          ...
          return (
            ...
            >
              ...
              <div className="col-span-2">₹{total * 10}</div>
          ...
          {cartItem && Object.keys(cartItem).length > 0 ? (
            token ? (
              <button
                ...
                className="w-full bg-orange-500 cursor-pointer text-white py-3 rounded-lg font-semibold hover:bg-orange-600 transition mt-6"
              >
                Proceed to Checkout
              </button>
            ) : (
              <button
                onClick={() => toast.warning("Login to Place Order")}
                className="w-full bg-orange-500 cursor-pointer text-white py-3 rounded-lg font-semibold hover:bg-orange-500 transition mt-6"
              >
                Login to Checkout
              </button>
            )
